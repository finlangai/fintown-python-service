...
Yêu cầu: Kết thúc mỗi ý bằng dấu ';', phân tích ngắn gọn (dưới 150 từ) về {metric_cluster_name} của công ty {symbol} dựa trên dữ liệu đã cho theo tiếng Việt. Tránh đưa ra ý kiến chủ quan, không cần giải thích nguyên nhân, chỉ tập trung vào số liệu, không cần mở đầu bằng dựa trên.
"""
